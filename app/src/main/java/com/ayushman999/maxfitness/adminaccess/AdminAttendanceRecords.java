...
public class AdminAttendanceRecords extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, AdapterView.OnItemClickListener{
    TextView DateView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_records);
        DateView=(TextView) findViewById(R.id.date_textview);
        getDate=(Button) findViewById(R.id.date_btn);
        getRecord=(Button) findViewById(R.id.view_atttendance);
        timeSpinner=(Spinner) findViewById(R.id.admin_time_spinner);
        ...
        getRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent transfer=new Intent(getApplicationContext(),AdminAttendanceView.class);
                transfer.putExtra("timing",timing);
                transfer.putExtra("date",date);
                startActivity(transfer);
                Toast.makeText(AdminAttendanceRecords.this, date+"\n"+timing, Toast.LENGTH_SHORT).show();
            }
        });
    }
