...
import com.ayushman999.maxfitness.adminaccess.PackageCheck;
...
public class ExpiringPackage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView=inflater.inflate(R.layout.activity_package_check, container, false);
        packageList=(RecyclerView) myView.findViewById(R.id.admin_package_recyclerview);
    ...
    private void setAdapter() {
        packageAdapter adapter=new packageAdapter(expiringUsers,getContext());
